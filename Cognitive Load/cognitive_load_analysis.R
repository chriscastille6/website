...
# Define the two experimental conditions
christian_values_text <- "We are driven by Christian values that honor God in all we do, reflecting His love, grace, and truth. We close on Sundays to observe the Sabbath. We strive to honor God through our work. These biblical Christian values guide our firm, employees, and customers."

non_christian_values_text <- "We celebrate diversity in all forms."
