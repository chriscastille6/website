    ...
    tabPanel("About",
             ...
             fluidRow(
               column(12,
                      ...
                      h4("Important Notes:"),
                      tags$ul(
                        tags$li("Cognitive load classifications are arbitrary and for descriptive purposes only"),
                        ...
                        tags$li("This tool uses the quanteda package for text analysis")
                      ),
                      
                      h4("References:"),
                      tags$ul(
                        tags$li("Flesch, R. (1948). A new readability yardstick. Journal of Applied Psychology, 32(3), 221-233."),
                        tags$li("Sweller, J. (1988). Cognitive load during problem solving: Effects on learning. Cognitive Science, 12(2), 257-285."),
                        tags$li("Kintsch, W., & van Dijk, T. A. (1978). Toward a model of text comprehension and production. Psychological Review, 85(5), 363-394."),
                        tags$li("Graesser, A. C., McNamara, D. S., & Kulikowich, J. M. (2011). Coh-Metrix: Providing multilevel analyses of text characteristics. Educational Researcher, 40(5), 223-234."),
                        tags$li("Mayer, R. E. (2005). Cognitive theory of multimedia learning. The Cambridge Handbook of Multimedia Learning, 31-48.")
                      )
               )
             )
    )
